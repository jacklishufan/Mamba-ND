...
visualizer = dict(
    ...
    vis_backends=[
        dict(type='LocalVisBackend'),
        dict(
            init_kwargs=dict(name='ucf_101_base_mamba_wd0.05_dr0.2'),
            type='WandbVisBackend'),
    ])
work_dir = './work_dirs/swin-tiny-p244-w877_in1k-pre_8xb8-amp-32x2x1-30e_kinetics400-rgb-mamba-6.7_ucf'
